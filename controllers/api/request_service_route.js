...
// const mailchimpClient = require("@mailchimp/mailchimp_transactional")("MQ0pLk82xHWK2bgI_D7JNQ");
...
//     try{
//     const response = await mailchimpClient.messages.send({ message: req.body});
